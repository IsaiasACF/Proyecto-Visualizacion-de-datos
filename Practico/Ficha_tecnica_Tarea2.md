...
## Canales
- **Posición:** los nodos de la izquierda representan la *frecuencia de uso* (Todos los días, 3–5 veces, 1–2 veces, Rara vez) y los de la derecha el propósito (Estudio, Resumen, Programación, Redacción, Trabajo, Ocio, Otro).
- **Grosor del enlace (tamaño, cuantitativo):** el ancho de cada banda representa el *volumen de menciones* de esa combinación frecuencia→propósito.
- **Color – matiz:** distingue los flujos según su origen/categoría.
...
| **Tipografía** | Sans serif. | Lectura clara de las etiquetas de nodos a ambos lados. |
| **Líneas** | Nodos como rectángulos finos; enlaces sin borde, solo relleno. | Mantiene el foco en el flujo y evita ruido. |
